...
Did we mention the eye-popping 12 themes hand-crafted for the mobile web? That's right, 12 mobile themes including some of the fastest and most efficient available today. Themes for all types of websites, blogs, corporate, ecommerce, and more!
...
+ Added nonce to AJAX request.

= 3.8 =

+ Improved exploit fix.
...
+ Fixed exploit with resize script.
